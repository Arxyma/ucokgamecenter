...
<html lang="en">
  <head>
    ...
    <title>UCOK GAME CENTER | Jebres</title>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('template/assets/datatables/dataTables.bootstrap5.min.css')}}" /> --}}
        ...
        <div class="sidebar-wrapper active">
          ...
          <div class="sidebar-menu">
            ...
            <ul class="menu">
              ...
              <li class="sidebar-item">
                <a href="/kaset" class="sidebar-link">
              ...
              <li class="sidebar-item">
                <a href="/penyewa" class="sidebar-link">
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu submenu-open">
                  <li class="submenu-item">
                    <a href="/akun/admin" class="submenu-link"
                      >Admin</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="/akun/penyewa" class="submenu-link"
                      >User</a
                    >
                  </li>
                </ul>
                            ...
                            <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="user-menu d-flex">
                                    <div class="user-name text-end me-3">
                                        ...
                                        {{-- <h6 class="mb-0 text-gray-600">Admin KW</h6> --}}
